...
export default function ScreenshotGallery() {
  ...
  const screenshots = [
    ...
    { src: "/screenshots/file_scan.png", title: t("screenshots.3.title"), description: t("screenshots.3.description") },
    { src: "/screenshots/photo_scan.png", title: t("screenshots.4.title"), description: t("screenshots.4.description") },
    { src: "/screenshots/my-valut-light.png", title: t("screenshots.5.title"), description: t("screenshots.5.description") },
    { src: "/screenshots/password-maker-light.png", title: t("screenshots.6.title"), description: t("screenshots.6.description") },
    { src: "/screenshots/test-password-light.png", title: t("screenshots.7.title"), description: t("screenshots.7.description") },
    { src: "/screenshots/secret-messages-light.png", title: t("screenshots.8.title"), description: t("screenshots.8.description") },
    { src: "/screenshots/phishing-dojo-light.png", title: t("screenshots.9.title"), description: t("screenshots.9.description") },
    { src: "/screenshots/quiz arena-light.png", title: t("screenshots.10.title"), description: t("screenshots.10.description") },
    { src: "/screenshots/Scenario_simulator.png", title: t("screenshots.11.title"), description: t("screenshots.11.description") },
    { src: "/screenshots/Security_posture.png", title: t("screenshots.12.title"), description: t("screenshots.12.description") },
    { src: "/screenshots/setting-chose- avatrs-light.png", title: t("screenshots.13.title"), description: t("screenshots.13.description") },
    { src: "/screenshots/ask_nova.png", title: t("screenshots.14.title"), description: t("screenshots.14.description") },
  ];
